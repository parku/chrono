...
function mergeResult(e,t,n){var i=t.start,r=n.start,s=mergeDateTimeComponent(i,r);if(null!=t.end||null!=n.end){var a=null==t.end?t.start:t.end,m=null==n.end?n.start:n.end,o=mergeDateTimeComponent(a,m);null==t.end&&o.date().getTime()<s.date().getTime()&&(o.isCertain("day")?o.assign("day",o.get("day")+1):o.imply("day",o.get("day")+1)),t.end=o}t.start=s;var u=Math.min(t.index,n.index),g=Math.max(t.index+t.text.length,n.index+n.text.length);t.index=u,t.text=e.substring(u,g);for(var l in n.tags)t.tags[l]=!0;return t.tags.ENMergeDateAndTimeRefiner=!0,t}var ParsedComponents=require("../../result").ParsedComponents,Refiner=require("../refiner").Refiner,PATTERN=new RegExp("^\\s*(T|at|after|before|on|of|,|-)?\\s*$"),isDateOnly=exports.isDateOnly=function(e){return!e.start.isCertain("hour")},isTimeOnly=exports.isTimeOnly=function(e){return!e.start.isCertain("month")&&!e.start.isCertain("weekday")},isAbleToMerge=exports.isAbleToMerge=function(e,t,n){return e.substring(t.index+t.text.length,n.index).match(PATTERN)},mergeDateTimeComponent=exports.mergeDateTimeComponent=function(e,t){var n=e.clone();return t.isCertain("hour")?(n.assign("hour",t.get("hour")),n.assign("minute",t.get("minute")),n.assign("second",t.get("second"))):(n.imply("hour",t.get("hour")),n.imply("minute",t.get("minute")),n.imply("second",t.get("second"))),t.isCertain("meridiem")?n.assign("meridiem",t.get("meridiem")):void 0!==t.get("meridiem")&&void 0===n.get("meridiem")&&n.imply("meridiem",t.get("meridiem")),1==n.get("meridiem")&&n.get("hour")<12&&(t.isCertain("hour")?n.assign("hour",n.get("hour")+12):n.imply("hour",n.get("hour")+12)),n};exports.Refiner=function(){Refiner.call(this),this.refine=function(e,t,n){if(t.length<2)return t;for(var i=[],r=null,s=null,a=1;a<t.length;a++)r=t[a],s=t[a-1],isDateOnly(s)&&isTimeOnly(r)&&isAbleToMerge(e,s,r)?(s=mergeResult(e,s,r),r=t[a+1],a+=1):isDateOnly(r)&&isTimeOnly(s)&&isAbleToMerge(e,s,r)&&(s=mergeResult(e,r,s),r=t[a+1],a+=1),i.push(s);return null!=r&&i.push(r),i}};
